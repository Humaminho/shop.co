'use client';
import ShopDropDown from './shop-drop-down';
...
export default function ShopNav() {
	...
	return (
		<li className="relative group/shop" onClick={() => setOpen(!open)}>
			<a className="flex gap-2 items-center cursor-pointer px-3 py-5 border-b-2 border-transparent hover:border-black transition duration-100">
				<p>Shop</p>
				<svg
					...
					viewBox="0 0 16 16"
					fill="none"
					className="group-hover/shop:translate-y-[3px] duration-100"
				>
					<path
			...
			{open && <ShopDropDown setOpen={setOpen} />}
		</li>
	);
}
