...
export default function PopUp() {
	return (
		<div className="bg-black">
			<div className="flex justify-center text-white relative px-4 lg:px-8 xl:px-24 max-w-[80rem] mx-auto">
				...
				<svg
					...
					className="absolute right-4 lg:right-8 xl:right-24 top-1/2 -translate-y-1/2 cursor-pointer"
				>
					<path
