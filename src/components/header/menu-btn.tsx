...
export default function MenuBtn() {
	function openNav() {
		...
		setTimeout(() => {
			...
			mobileNavEl?.classList.remove('rounded-br-full');
			mobileNavEl?.classList.add('text-white');
		}, 1);
	}
	...
	return (
		<>
			<button
				onClick={openNav}
				className="lg:hidden p-2 hover:bg-light-gray rounded-full transition duration-75"
			>
				<svg
					width="24"
					height="24"
